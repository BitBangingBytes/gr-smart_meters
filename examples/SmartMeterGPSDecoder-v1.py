...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print('')
        print('Usage : python3 SmartMeterGPSDecoder-v1.py hostname port')
        print('')
        sys.exit()
    ...
    print('')
    print('MeterID, upTime(secs), upTime(days rounded), GPSlat, GPSlon, epoch')
        ...
        for sock in sdr_read_sockets:
            ...
            if sock == s:
                ...
                if not sdrData:
                    ...
                    if str(hex(sdrData[3])) == "0x55" and str(hex(sdrData[13])) == "0xfe":  # Non-GPS Routed Data
                    ...
                    # Decode GPS data
                    elif str(hex(sdrData[3])) == "0x55" and str(hex(sdrData[13])) != "0xfe":  # GPS Routed Data
                        ...
                        print( str(binascii.hexlify(meterID).decode()).upper() + ", " +
                               str(upTime) + ", " + str(int(upTime / 60 / 60 / 24)) + ", " +
