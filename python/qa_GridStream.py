...
class qa_GridStream(gr_unittest.TestCase):
    ...
    def test_001_complete_packet_pass_through(self):
        ...
        self.expected_meta = pmt.dict_add(self.expected_meta, pmt.intern("Gridstream_Uptime"), pmt.from_uint64(17770312))
        ...
        meta = pmt.car(self.debug.get_message(0))
        
        self.assertEqual(1, self.debug.num_messages())
        self.assertListEqual(list(pmt.to_python(data)), expected_data)
        self.assertDictEqual(pmt.to_python(meta), pmt.to_python(self.expected_meta))
